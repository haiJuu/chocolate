...
while ($fetch_product2 = $product2->fetch()) { ?>
    <?php if ($row_num % 4 == 1) { ?>
        ...
        <div class="card col-md-2 col-sm-4 col-6">
            <a href="goods.php?p_id=<?php echo $fetch_product2['p_id']; ?>"><img src="./images/product/<?php echo $fetch_product2['img_file']; ?>" class="card-img-top" alt="<?php echo $fetch_product2['p_name']; ?>" title="<?php echo $fetch_product2['p_intro']; ?>"></a>
            <div class="card-body">
